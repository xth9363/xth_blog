...
class Asset(models.Model):
    ...
    admin = models.ForeignKey(UserProfile, null=True, blank=True, verbose_name='资产管理员', related_name='admin',on_delete=models.SET_NULL)
    ...
    approved_by = models.ForeignKey(UserProfile, null=True, blank=True, verbose_name='批准人', related_name='approved_by',on_delete=models.SET_NULL)
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey(UserProfile, blank=True, null=True, verbose_name='事件执行人',
